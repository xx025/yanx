...
from pys.download_university_info.get_major_details import dl_details
from pys.download_university_info.get_recruit_majors import dl_majors
from pys.download_university_info.get_recruit_schools import dl_schools
