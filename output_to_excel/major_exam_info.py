...
# 读文件夹文件，获取文件名列表
u_list = []
for filename in os.listdir("../college_majors_exam_scope/"):
...
for filename in u_list:
    with open('../college_majors_exam_scope/{}.json'.format(filename), 'r', encoding='utf8') as f:
...
wb.save('../documentation/院校专业0812.xlsx')
